...
/**
 * Returns an icon component representing the ticket priority.
 * @param priority - The priority label ("No priority", "Low", "Medium", "High", "Urgent").
 * @returns A React element representing the priority icon.
 */
...
/**
 * Returns an icon component representing the ticket status.
 * @param status - The status label ("Backlog", "Todo", "In progress", "Done", "Canceled").
